  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Button
          variant="contained"
          className="insta-gradient hover:bg-indigo-500 text-white  transition-all hover: rounded-xl py-2.5 px-5"
        ...
        {[
          ...
          <Grid item xs={12} md={4} key={i}>
            <motion.div variants={itemVariants} className="h-full">
              <div className="h-full rounded-2xl border border-[#363636] bg-white/5 p-5 backdrop-blur-xl transition-all hover:bg-white/10 hover:border-[#363636] relative overflow-hidden group">
      ...
      <Grid container spacing={3} className="mt-2">
        <Grid item xs={12} lg={6}>
          <motion.div variants={itemVariants} className="h-full">
            <div className="rounded-2xl border border-[#363636] bg-[#121212]/80 backdrop-blur-xl p-6 h-full flex flex-col">
              <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                <AutoAwesomeIcon className="text-indigo-400" style={{ fontSize: 22 }} />
                Top Recommendation
              </h2>
              <div className="rounded-xl border border-[#363636] bg-white/5 p-4 flex gap-4 flex-1 transition-all hover:bg-white/10 group">
                <div className="w-24 h-32 rounded-lg border border-[#363636] overflow-hidden shrink-0 relative">
                ...
                <div className="flex flex-col justify-between flex-1">
                  ...
                  <div className="flex justify-end gap-2 mt-3">
                    <button className="px-4 py-1.5 text-sm font-medium text-white border border-[#363636] rounded-lg hover:bg-white/10 transition-colors">
                      Edit
                    </button>
                    <button className="px-4 py-1.5 text-sm font-medium text-white insta-gradient rounded-lg  hover:bg-indigo-500 transition-all">
                      Approve
                    </button>
                  </div>
                </div>
            ...
            <div className="rounded-2xl border border-[#363636] bg-[#121212]/80 backdrop-blur-xl p-6 h-full flex flex-col">
              ...
              <div className="flex flex-col gap-2.5 flex-1 justify-center">
                {[
                  ...
                  { title: "Weekly Insights Carousel", time: "Tomorrow, 10:00 AM", color: "insta-gradient", shadow: "shadow-purple-500/50" },
                  { title: "Community Q&A Prompt", time: "Friday, 4:00 PM", color: "bg-emerald-500", shadow: "shadow-emerald-500/50" },
                ].map((item, i) => (
                  <div key={i} className="flex items-center justify-between p-3.5 rounded-xl border border-transparent hover:bg-white/5 hover:border-[#363636] transition-all group cursor-pointer">
