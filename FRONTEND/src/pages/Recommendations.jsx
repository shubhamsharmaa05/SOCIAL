    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="space-y-6">
        {[
          ...
          <div key={i} className="glass-panel p-6 rounded-xl relative overflow-hidden group border border-white/5 hover:border-primary/30 transition-colors">
            {i === 0 && (
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="w-32 h-32 bg-zinc-800 rounded-lg shrink-0 border border-white/10" />
              <div className="flex-1">
                ...
                <div className="bg-black/50 border border-white/5 rounded-lg p-3 mt-4">
                  <p className="text-sm text-zinc-400 mb-2 font-medium">AI Generated Caption:</p>
