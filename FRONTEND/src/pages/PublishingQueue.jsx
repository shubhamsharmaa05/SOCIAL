...
const PublishingQueue = () => {
  ...
  const queue = [
    ...
    { status: "scheduled", title: "Weekly Newsletter Promo", platform: "LinkedIn", time: "Tomorrow, 9:00 AM", icon: ScheduleIcon, color: "text.secondary", bg: "#363636" },
  ...
  return (
    <Box sx={{ width: "100%", display: "flex", flexDirection: "column", gap: 3 }}>
      ...
      <Paper elevation={0} sx={{ borderRadius: 3, border: "1px solid #363636", bgcolor: "background.paper", overflow: "hidden" }}>
        <Box sx={{ borderBottom: 1, borderColor: "#363636" }}>
              ...
              >
                ...
                <Button
                  ...
                  sx={{
                    ...
                    "&:hover": { bgcolor: "#363636", borderColor: "rgba(255, 255, 255, 0.2)" },
                  }}
                >
                  {item.status === 'failed' ? 'Retry' : 'View'}
                </Button>
              </ListItem>
              {i < filteredQueue.length - 1 && <Divider sx={{ borderColor: "#363636" }} />}
            </Box>
          ))}
