...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const detail = err.response?.data?.detail || err.response?.data?.message || err.message || 'Login failed';
    ...
    <div className="min-h-screen bg-transparent text-white flex items-center justify-center p-4 selection:bg-primary/30 relative">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-panel p-8 rounded-2xl border border-[#363636] ">
          ...
          <p className="text-[#A8A8A8] mb-8 text-sm">Sign in to access your command center.</p>
          ...
          <div className="mt-8 text-center text-sm text-[#A8A8A8] space-y-2">
            <p>
